...
export MU2E_ART_SQUALIFIER=s103
...
setup -B art v3_05_02 -q${MU2E_UPS_QUALIFIERS}
setup -B art_root_io v1_03_02 -q${MU2E_UPS_QUALIFIERS}
...
# setup -B mu2e_artdaq_core v1_04_01 -q${MU2EQ_UPS_QUALIFIERS}:+${MU2E_ART_SQUALIFIER}:offline
setup -B mu2e_artdaq_core v1_05_02 -q${MU2E_UPS_QUALIFIERS}:+${MU2E_ART_SQUALIFIER}:offline

# Other libraries we need.
setup -B pcie_linux_kernel_module v2_03_09 -q${MU2E_UPS_QUALIFIERS}:+${MU2E_ART_SQUALIFIER}
