...
#------------------------------------------------------------------------------
        ...
        job.fInputDataset            = Dataset('generator','rpce0s00b0','local');
...
#------------------------------------------------------------------------------
# s4:sim_b1 : 1-batch mode CE dataset, no concatenation needed, 100M = 200 (segments)x500K (events per segment)
#------------------------------------------------------------------------------
        ...
        job.fNInputFiles             = 200                      # number of the job segments for 1M events total
        job.fNEventsPerSegment       = 500000                   # for 1-batch mode signal+minbias events generate 2000 events/segment
        define_mixing_inputs(job);

        job.fMaxInputFilesPerSegment =  1                       # =1 MC generator
        job.fResample                = 'no'                     # yes/no
        job.fMaxMemory               = '3000MB'
        job.fRequestedTime           = '12h'
        job.fIfdh                    = 'xrootd'                 # ifdh/xrootd
        ...
        job.fDescription             = desc;
#------------------------------------------------------------------------------
# s4:sim_b2 : 2-batch mode CE dataset, no concatenation needed , 100M = 200(segments)x500K(events per segment)
#------------------------------------------------------------------------------
        ...
        job.fMaxInputFilesPerSegment =  1                                 # MC generator
        job.fNEventsPerSegment       =  5000000                           # for 1-batch mode signal+minbias events generate 2000 events/segment
        job.fResample                = 'no'                               # yes/no
        job.fMaxMemory               = '3000MB'
        job.fRequestedTime           = '12h'
        job.fIfdh                    = 'xrootd'                           # ifdh/xrootd
...
#------------------------------------------------------------------------------
        ...
        job.fInputDsID               = 'rpce0s41b0'                       # concatenation
        dsn                          = 'dig.mu2e.rpce0s41b0.Mu2eII.art'   # dataset: mu2e.rpce0s41b0.Mu2eII.art
        job.fInputDataset            = Dataset(dsn,'rpce0s41b0','local')  # dataset: mu2e.rpce0s41b0.Mu2eII.art
