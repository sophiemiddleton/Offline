...
//
///////////////////////////////////////////////////////////////////////////////
#ifndef Stntuple_ana_TPbarAnaModule_hh
#define Stntuple_ana_TPbarAnaModule_hh
...
namespace Mu2eII {
class TPbarAnaModule: public TAnaModule {
public:
  enum { kNTrackPar        =    20 };
...
//-----------------------------------------------------------------------------
public:
  TPbarAnaModule(const char* name="Mu2eII_PbarAna", const char* title="PbarAna");
  ~TPbarAnaModule();
//-----------------------------------------------------------------------------
// accessors
//-----------------------------------------------------------------------------
