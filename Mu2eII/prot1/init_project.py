...
#------------------------------------------------------------------------------
        ...
        job.fInputDataset            = Dataset('generator','prot1s00b0','local');
...
#------------------------------------------------------------------------------
        ...
        job.fInputDsID               = 'prot1s41b0'                       # concatenation
        dsn                          = project+'.'+job.fInputDsID+'.art'  # dataset: mu2e.prot1s41b0.Mu2eII.art
        job.fInputDataset            = Dataset(dsn,'prot1s41b0','local')  # dataset: mu2e.prot1s41b0.Mu2eII.art
