...
#------------------------------------------------------------------------------
        ...
        job.fInputDataset            = Dataset('generator','peno0s00b0','local');
...
#------------------------------------------------------------------------------
        ...
        job.fInputDsID               = 'peno0s41b0'                       # concatenation
        dsn                          = project+'.'+job.fInputDsID+'.art'  # dataset: mu2e.peno0s41b0.Mu2eII.art
        job.fInputDataset            = Dataset(dsn,'peno0s41b0','local')  # dataset: mu2e.peno0s41b0.Mu2eII.art
...
#------------------------------------------------------------------------------
        ...
        dsn                          = 'dig.mu2e.peno0s41b0.Mu2eII.art'  # 
        job.fInputDataset            = Dataset(dsn,'peno0s41b0','local') # dataset: mu2e.peno0s41b0.Mu2eII.art
