...
#------------------------------------------------------------------------------
        ...
        job.fInputDataset            = Dataset('generator','rpci1s00b0','local');
...
#------------------------------------------------------------------------------
        ...
        job.fInputDsID               = 'rpci1s41b0'                       # concatenation
        dsn                          = project+'.'+job.fInputDsID+'.art'  # dataset: mu2e.rpci1s41b0.Mu2eII.art
        job.fInputDataset            = Dataset(dsn,'rpci1s41b0','local')  # dataset: mu2e.rpci1s41b0.Mu2eII.art
...
#------------------------------------------------------------------------------
        ...
        dsn                          = 'dig.mu2e.rpci1s41b0.Mu2eII.art'  # 
        job.fInputDataset            = Dataset(dsn,'rpci1s41b0','local') # dataset: mu2e.rpci1s41b0.Mu2eII.art
