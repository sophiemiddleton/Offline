...
#------------------------------------------------------------------------------
    def __init__(self):
        ...
        job.fInputDsID               = 'rmci0s00b0'        # muon stops
        ...
        job.fInputDsID               = 'rmci0s41b0'                       # concatenation
        dsn                          = project+'.'+job.fInputDsID+'.art'  # dataset: mu2e.rmci0s41b0.Mu2eII.art
        job.fInputDataset            = Dataset(dsn,'rmci0s41b0','local')  # dataset: mu2e.rmci0s41b0.Mu2eII.art
        ...
        job.fInputDsID               = 'rmci0s41b0'                      # dsID
        dsn                          = project+'.'+job.fInputDsID+'.art' # dataset: mu2e.rmci0s41b0.Mu2eII.art
        job.fInputDataset            = Dataset(dsn,'rmci0s41b0','local') # dataset: mu2e.rmci0s41b0.Mu2eII.art
