...
#------------------------------------------------------------------------------
    def __init__(self):
        ...
        job.fInputDsID               = 'fele0s00b0'        # muon stops
...
#------------------------------------------------------------------------------
        ...
        job.fInputDsID               = 'fele0s41b0'                       # concatenation
        dsn                          = project+'.'+job.fInputDsID+'.art'  # dataset: mu2e.fele0s41b0.Mu2eII.art
        job.fInputDataset            = Dataset(dsn,'fele0s41b0','local')  # dataset: mu2e.fele0s41b0.Mu2eII.art
        ...
        job.fInputDsID               = 'fele0s41b0'                      # dsID
        dsn                          = project+'.'+job.fInputDsID+'.art' # dataset: mu2e.fele0s41b0.Mu2eII.art
        job.fInputDataset            = Dataset(dsn,'fele0s41b0','local') # dataset: mu2e.fele0s41b0.Mu2eII.art
