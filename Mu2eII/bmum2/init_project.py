...
#------------------------------------------------------------------------------        
        ...
        job.fInputDsID             = 'bmum2s00b0'              # generator
...
#------------------------------------------------------------------------------        
        ...
        job.fInputDsID             = 'bmum2s11b0'
        dsn                        = project+'.'+job.fInputDsID+'.art' ;
        job.fInputDataset          = Dataset(dsn,'bmum2s11b0','local')
        job.fNInputFiles           = -1
        ...
        self.fStage[s.name()]      = s;
#------------------------------------------------------------------------------
# bmum2 3rd stage uses input from the 2nd stage of bmum0
#------------------------------------------------------------------------------        
        s                          = Stage('s3');
        ...
        job.fInputDsID             = 'bmum0s31b0'
        dsn                        = project+'.'+job.fInputDsID+'.art' ;
        job.fInputDataset          = Dataset(dsn,'bmum0s31b0','local')
        job.fNInputFiles           = -1
