...
#------------------------------------------------------------------------------
        ...
        job.fInputDataset            = Dataset('dig.oksuzian.CRY-cosmic-general.cry3-digi-hi.art','cry33s00b0','local');

        job.fNInputFiles             = -1                  # defined by the dataset
        job.fMaxInputFilesPerSegment = 10                  # 10 files per segment
...
#------------------------------------------------------------------------------
        ...
        job.fInputDataset            = Dataset('dig.mu2e.cry33s41b0.Mu2eII.art','cry33s41b0','sam') 
