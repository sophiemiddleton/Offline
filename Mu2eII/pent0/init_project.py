...
#------------------------------------------------------------------------------
        ...
        job.fInputDataset            = Dataset('generator','pent0s00b0','local');
...
#------------------------------------------------------------------------------
        ...
        job.fInputDsID               = 'pent0s41b0'                       # concatenation
        dsn                          = project+'.'+job.fInputDsID+'.art'  # dataset: mu2e.pent0s41b0.Mu2eII.art
        job.fInputDataset            = Dataset(dsn,'pent0s41b0','local')  # dataset: mu2e.pent0s41b0.Mu2eII.art
...
#------------------------------------------------------------------------------
        ...
        dsn                          = 'dig.mu2e.pent0s41b0.Mu2eII.art'  # 
        job.fInputDataset            = Dataset(dsn,'pent0s41b0','local') # dataset: mu2e.pent0s41b0.Mu2eII.art
