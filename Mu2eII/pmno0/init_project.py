...
#------------------------------------------------------------------------------
        ...
        job.fInputDataset            = Dataset('generator','pmno0s00b0','local');
...
#------------------------------------------------------------------------------
        ...
        job.fInputDsID               = 'pmno0s41b0'                       # concatenation
        dsn                          = project+'.'+job.fInputDsID+'.art'  # dataset: mu2e.pmno0s41b0.Mu2eII.art
        job.fInputDataset            = Dataset(dsn,'pmno0s41b0','local')  # dataset: mu2e.pmno0s41b0.Mu2eII.art
...
#------------------------------------------------------------------------------
        ...
        dsn                          = 'dig.mu2e.pmno0s41b0.Mu2eII.art'  # 
        job.fInputDataset            = Dataset(dsn,'pmno0s41b0','local') # dataset: mu2e.pmno0s41b0.Mu2eII.art
