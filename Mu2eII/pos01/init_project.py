...
#------------------------------------------------------------------------------
        ...
        job.fInputDataset            = Dataset('generator','pos01s00b0','local');
...
#------------------------------------------------------------------------------
        ...
        dsn                          = 'dig.mu2e.pos01s41b0.Mu2eII.art'   # dataset: mu2e.pos01s41b0.Mu2eII.art
        job.fInputDataset            = Dataset(dsn,'','local')            # dataset: mu2e.pos01s41b0.Mu2eII.art
...
#------------------------------------------------------------------------------
        ...
        dsn                          = 'mcs.mu2e.pos01s51b0.Mu2eII.art'  # dataset: mu2e.pos01s41b0.Mu2eII.art
        job.fInputDataset            = Dataset(dsn,'','sam')             # dataset: mu2e.pos01s41b0.Mu2eII.art
        job.fNInputFiles             = -1                                # placeholder, the real number is defined by the input dataset
