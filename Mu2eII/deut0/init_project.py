...
#------------------------------------------------------------------------------
        ...
        job.fInputDataset            = Dataset('generator','deut0s00b0','local');
...
#------------------------------------------------------------------------------
        ...
        job.fInputDsID               = 'deut0s41b0'                       # concatenation
        dsn                          = project+'.'+job.fInputDsID+'.art'  # dataset: mu2e.deut0s41b0.Mu2eII.art
        job.fInputDataset            = Dataset(dsn,'deut0s41b0','local')  # dataset: mu2e.deut0s41b0.Mu2eII.art
