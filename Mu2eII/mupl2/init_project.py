...
#------------------------------------------------------------------------------
    def __init__(self):
        ...
        job.fInputDsID               = 'mupl2s00b0'        # muon stops
        ...
        job.fInputDsID               = 'mupl2s41b0'                       # concatenation
        dsn                          = project+'.'+job.fInputDsID+'.art'  # dataset: mu2e.mupl2s41b0.Mu2eII.art
        job.fInputDataset            = Dataset(dsn,'mupl2s41b0','local')  # dataset: mu2e.mupl2s41b0.Mu2eII.art
        ...
        job.fInputDsID               = 'mupl2s41b0'                      # dsID
        dsn                          = project+'.'+job.fInputDsID+'.art' # dataset: mu2e.mupl2s41b0.Mu2eII.art
        job.fInputDataset            = Dataset(dsn,'mupl2s41b0','local') # dataset: mu2e.mupl2s41b0.Mu2eII.art
