...
#------------------------------------------------------------------------------
        ...
        job.fInputDataset            = Dataset('generator','pmnt0s00b0','local');
...
#------------------------------------------------------------------------------
        ...
        job.fInputDsID               = 'pmnt0s41b0'                       # concatenation
        dsn                          = project+'.'+job.fInputDsID+'.art'  # dataset: mu2e.pmnt0s41b0.Mu2eII.art
        job.fInputDataset            = Dataset(dsn,'pmnt0s41b0','local')  # dataset: mu2e.pmnt0s41b0.Mu2eII.art
...
#------------------------------------------------------------------------------
# s4:sim_digi_nocompression
#------------------------------------------------------------------------------
        s                            = self.new_stage('s4');
        job                          = s.new_job('sim_digi_nocompression');

        job.fRunNumber               = 1000;
        job.fBaseFcl                 = project+'/'+dsid+'/'+s.name()+'_sim_digi_nocompression_'+dsid+'.fcl'
        job.fInputStage              = 's0'
