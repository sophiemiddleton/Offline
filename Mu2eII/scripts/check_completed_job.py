...
# call: check_completed_job.py --project=Mu2eII --grid_id=11122234
#-------------------------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
    def init(self, gridID):
        ...
        self.fRunningDir   = 'tmp/Mu2eII/grid_job_status';
        self.fCompletedDir = 'tmp/Mu2eII/completed_jobs'
    ...
    def check_completed_job(self,job):
        ...
        for i in range(0,nseg):
            ...
            if (not os.path.exists(dd)):
                print('>> segment %5i: ERROR'%i,' output directory doesn\'t exist, fcl: ',fcl_list[i])
                if (next_fcl_dir):
