...
#------------------------------------------------------------------------------
        self.setObjectName(_fromUtf8("Mu2eII:ele00"))
        self.resize(920, 670)
...
#------------------------------------------------------------------------------
    def list_pnfs_output(self):
        ...
        cmd   = ['Mu2eII/scripts/list_pnfs_output.py', '--grid_id=',grid_id, '--verbose=','1'];
...
#------------------------------------------------------------------------------
    def build_tarball(self):
        ...
        cmd = ['Mu2eII/scripts/build_tarball.py', '--project',self.fConfig.fProject,'--verbose','1'];
...
#------------------------------------------------------------------------------
    def gen_fcl(self):
        ...
        cmd = ['setup python v3_7_2; Mu2eII/scripts/gen_fcl.py --project='+self.fConfig.fProject,
...
#------------------------------------------------------------------------------
    def grid_monitor(self):
        ...
        cmd = ['Mu2eII/scripts/grid_monitor.py','--project='+self.fConfig.fProject]
