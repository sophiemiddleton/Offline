...
#
# call examples: 
#               Mu2eII/scripts/submit_job.py --project=Mu2eII --dsid=cele0 --stage=s4 --job=sim [--doit=[yes/d]] [--fileset=...]
#
...
#------------------------------------------------------------------------------
    def ParseParameters(self):
        ...
        if (self.fRecover):
            ...
            fn              = 'tmp/Mu2eII/grid_job_status/'+self.fRecover;
...
#------------------------------------------------------------------------------
    def submit_grid_job(self,stage,job):
        ...
        cmd = 'cat .grid_config | grep Mu2eII.code_tarball | awk \'{print $2}\''
