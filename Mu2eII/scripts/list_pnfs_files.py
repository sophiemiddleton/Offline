#!/usr/bin/env python
# creates local list of output files produced by the job , places it into Mu2eII/$dsid/catalog area
# call: Mu2eII/scripts/list_pnfs_files.py --project=Mu2eII --grid_id=35469055
#-------------------------------------------------------------------------------------------------
...
# 
#         config_dir = os.getcwd()+'/tmp/'+self.fProject+'/completed_jobs'
...
#             self.fJob.fGridID = self.fGridID;
#                 
#         self.Print(name,1,'self.fGridID = %s' % self.fGridID)
#         return;
