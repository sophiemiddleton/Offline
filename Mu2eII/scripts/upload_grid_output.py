...
# call: upload_grid_output.py --project=Mu2eII --dsid=760_3000 --stage=ts1 --output_stream=mubeamout --grid_id=35469055
#-------------------------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
    def ParseParameters(self):
        ...
        fn              = 'tmp/Mu2eII/grid_job_status/'+self.fGridJobID;
