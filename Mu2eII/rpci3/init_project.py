...
#------------------------------------------------------------------------------
        ...
        job.fInputDataset            = Dataset('generator','rpci3s31b0','local'); # the pion stops ntuple is created by rpce2 workflow
...
#        job.fInputStage              = 's4'
        ...
        defname                      = 'dig.mu2e.rpci3s41b0.Mu2eII.art'  # 
        job.fInputDataset            = Dataset(defname,'rpci3s41b0','local') # dataset: mu2e.rpci3s41b0.Mu2eII.art
