...
//
#ifndef CosmicTrkDef_HH
#define CosmicTrkDef_HH
// Mu2e
...
namespace mu2e 
{
  ...
  class CosmicTrkDef {
  public:
    CosmicTrkDef(TimeCluster const& tcluster, CosmicLineTraj const& cosmic, TrkParticle const& tpart, TrkFitDirection const& fdir);
   
    CosmicTrkDef(const CosmicTrkDef&);
    CosmicTrkDef& operator = (const CosmicTrkDef&);
    ~CosmicTrkDef();
