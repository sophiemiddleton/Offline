...
bool Collection_Interface::getSelectedHitsName(std::string &className,
...
std::vector<Collection_Interface::trackInfoStruct> Collection_Interface::getSelectedTrackNames() const
{
...
const CollectionType* Collection_Interface::getSelectedHitCollection() const
{
  int i=_hitBox->GetSelected();
  int classID=0;
  int index=0;
...
template const mu2e::StepPointMCCollection* Collection_Interface::getSelectedHitCollection<mu2e::StepPointMCCollection>() const;
template const mu2e::StrawHitCollection*    Collection_Interface::getSelectedHitCollection<mu2e::StrawHitCollection>() const;
template const mu2e::KalRepCollection*  Collection_Interface::getSelectedHitCollection<mu2e::KalRepCollection>() const;
template const mu2e::KalSeedCollection*  Collection_Interface::getSelectedHitCollection<mu2e::KalSeedCollection>() const;

template<typename CollectionType>
const CollectionType* Collection_Interface::getSelectedCaloHitCollection() const
{
...
template const mu2e::StepPointMCCollection* Collection_Interface::getSelectedCaloHitCollection<mu2e::StepPointMCCollection>() const;
template const mu2e::CaloCrystalHitCollection* Collection_Interface::getSelectedCaloHitCollection<mu2e::CaloCrystalHitCollection>() const;
template const mu2e::CaloHitCollection*    Collection_Interface::getSelectedCaloHitCollection<mu2e::CaloHitCollection>() const;


template<typename CollectionType>
const CollectionType* Collection_Interface::getSelectedCrvHitCollection() const
{
...
template const mu2e::CrvRecoPulseCollection* Collection_Interface::getSelectedCrvHitCollection<mu2e::CrvRecoPulseCollection>() const;


template<typename CollectionType>
std::vector<const CollectionType*> Collection_Interface::getSelectedTrackCollection(std::vector<trackInfoStruct> &v) const
{
...
template std::vector<const mu2e::SimParticleCollection*> Collection_Interface::getSelectedTrackCollection<mu2e::SimParticleCollection>(std::vector<trackInfoStruct> &v) const;
template std::vector<const mu2e::KalRepCollection*> Collection_Interface::getSelectedTrackCollection<mu2e::KalRepCollection>(std::vector<trackInfoStruct> &v) const;
template std::vector<const mu2e::TrkExtTrajCollection*> Collection_Interface::getSelectedTrackCollection<mu2e::TrkExtTrajCollection>(std::vector<trackInfoStruct> &v) const;
template std::vector<const mu2e::KalSeedCollection*> Collection_Interface::getSelectedTrackCollection<mu2e::KalSeedCollection>(std::vector<trackInfoStruct> &v) const;

const mu2e::PhysicalVolumeInfoCollection* Collection_Interface::getPhysicalVolumeInfoCollection() const
{
  if(_hasPhysicalVolumes) return(_physicalVolumes.product());
  else return(nullptr);
}

const mu2e::PhysicalVolumeInfoMultiCollection* Collection_Interface::getPhysicalVolumeInfoMultiCollection() const
{
  if(_hasPhysicalVolumesMulti) return(_physicalVolumesMulti.product());
  else return(nullptr);
}

const mu2e::MCTrajectoryCollection* Collection_Interface::getMCTrajectoryCollection(const trackInfoStruct &t) const
{
...
const mu2e::StrawHitFlagCollection* Collection_Interface::getStrawHitFlagCollection() const
{
  int classID=0;
  int index=0;
  std::vector<entryStruct>::const_iterator iter;
...
const mu2e::StrawHitPositionCollection* Collection_Interface::getStrawHitPositionCollection() const
{
  return(nullptr);
}
