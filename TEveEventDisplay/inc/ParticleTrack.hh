/*//Based on EventDisplay version
#ifndef TEveEventDisplay_inc_ParticleTrack_h
#define TEvEventDisplay_inc_ParticleTrack_h
...
class ParticleTrack
{
  ...
  ParticleTrack(double x1, double y1, double z1, double t1,
        double x2, double y2, double z2, double t2,
        int particleId, int trackClass, int trackClassIndex, 
        double momentum,
        const TGeoManager *geomanager, TGeoVolume *topvolume, const boost::shared_ptr<ComponentInfo> info,
        bool isGeometry):
  ...
  void setFilter(unsigned int minPoints, double minTime, double maxTime, double minMomentum,bool showElectrons, bool showMuons, bool showGammas, bool showNeutrinos, bool showNeutrons, bool showOthers)
  {
